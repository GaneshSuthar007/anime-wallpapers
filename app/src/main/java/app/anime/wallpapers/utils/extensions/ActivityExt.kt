...
import app.anime.wallpapers.databinding.InfoDialogBinding
...
fun Activity.showInfoDialog(
    ...
    val infoDialogBinding: InfoDialogBinding =
        DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.info_dialog, null, false)
    infoDialogBinding.tvMessage.text = getString(title)
    infoDialogBinding.ivIcon.setImageResource(icon)
    infoDialogBinding.btnClose.setOnClickListener {
        dialog.dismiss()
        onClosed()
    }
